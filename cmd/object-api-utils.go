...
func NewGetObjectReaderFromReader(r io.Reader, oi ObjectInfo, cleanupFns ...func()) (*GetObjectReader, error) {
...
func NewGetObjectReader(rs *HTTPRangeSpec, oi ObjectInfo, cleanUpFns ...func()) (
	...
	case isCompressed:
		...
		if rs != nil {
			...
			// Incase of range queries on multiparts, the offset and length are reduced.
